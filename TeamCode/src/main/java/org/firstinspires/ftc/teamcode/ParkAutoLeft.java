...
@Autonomous(name="ParkAutoLeft", group="Linear Opmode")
//@Disabled
public class ParkAutoLeft extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        sleep(1000);
        driveTrain.gyroDrive(this, runtime, 0.2, 23, 0, 10);
        driveTrain.encoderStafe(this,runtime, .3,14, driveTrain.STRAFE_LEFT, 3);
