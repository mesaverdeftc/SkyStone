...
public class TylerSkystoneRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveTrain.gyroStrafeToBlock(this, runtime, distanceSensor, .2, 2.8, true, 90,10 );
        block.down();
        sleep(750);
        grabber.down();
        sleep(500);
        ...
        foundation.down();
        sleep(500);
        driveTrain.gyroDrive(this, runtime, -1, -30, 0,5);
        //driveTrain.gyroDrive(this, runtime, -.80, 4, 90, 4);
        foundation.up();
        driveTrain.encoderStafe(this, runtime, 1, 65, DriveTrain.STRAFE_LEFT, 10 );
        sleep(1000000);
