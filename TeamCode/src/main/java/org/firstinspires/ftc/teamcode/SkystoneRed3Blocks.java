...
@Autonomous(name="SkystoneRed3Blocks", group="Linear Opmode")
//@Disabled
public class SkystoneRed3Blocks extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveTrain.encoderStafe(this,runtime, .2,.3, driveTrain.STRAFE_RIGHT, 3);
        ...
        foundation.down();
        sleep(700);
        driveTrain.gyroDrive_constant(this, runtime, -0.85, -30,35, 10);
        ...
        driveTrain.gyroDrive(this, runtime, -1, -35, 0, 20);
