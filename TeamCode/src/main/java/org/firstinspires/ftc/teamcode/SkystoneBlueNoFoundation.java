...
@Autonomous(name="SkystoneBlueNoFoundation", group="Linear Opmode")
//@Disabled
public class SkystoneBlueNoFoundation extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveTrain.gyroDrive(this, runtime, 1.0, 42 + (offset*8),0,7);
        sleep(200);
        ...
        sleep(200);
        //driveTrain.encoderStafe(this,runtime, .5,4, driveTrain.STRAFE_RIGHT, 3);
        driveTrain.gyroDrive(this, runtime, -1.0, -42,0,7);
