...
public class SkystoneBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveTrain.gyroDrive(this, runtime, .4,36 +(offset*8.6),0,7);
        sleep(2000);
/*
        sleep(200);
        ...
        driveTrain.encoderStafe(this,runtime, .5,6, driveTrain.STRAFE_LEFT, 3);
        ...
        foundation.up();
        driveTrain.encoderStrafeOffsetDown(this, runtime, .4, 37, DriveTrain.STRAFE_RIGHT, 10);
        /*
